...
public class BandAlbumServiceTest {
    ...
    @BeforeEach
    public void setup() {
        bandAlbumService = new BandAlbumService(bandAlbumRepository);
    }
    ...
    public void testSaveAlbumIsDelegatedToRepository() {
        // when: save() est appelé sur un objet Album
        bandAlbumService.save(album);
        // then: save() du dépôt associé au service est invoqué
        verify(bandAlbumService.getBandAlbumRepository()).save(album);
    }
    ...
    @Test
    public void testExceptionIsThrownWhenSavingNullBand() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> bandAlbumService.save((Band) null));
    }

    @Test
    public void testExceptionIsThrownWhenFindingBandWithNullId() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> bandAlbumService.findBandById(null));
    }
