...
public class BandAlbumRepositoryIntegrationTest {
    ...
    @Test
    public void testSaveNonValidAlbum() {

        // given: a non valid Album
        album.setTitle(null);
        ...
        Assertions.assertThrows(ConstraintViolationException.class,
                () -> { bandAlbumRepository.getEntityManager().flush(); });
    }
    ...
    @Test
    public void testSaveNonValidBand() {

        // given: a non valid Band
        band.setName("");
