...
public class BandControllerIntegrationTest {
    ...
    public void testReadBandIdValide() throws Exception{
        ...
        // when: on simule une requête HTTP de type GET vers "/band/{id}" avec un id valide
    ...
    public void testReadBandIdInvalide() throws Exception{
        // given: un objet MockMvc qui simule des échanges MVC
        // when: on simule une requête HTTP de type GET vers "/band/{id}" avec un id invalide
    ...
    public void testCreateBand() throws Exception{
        // given: un objet MockMvc qui simule des échanges MVC
        // when: on simule une requête HTTP de type GET vers "/band/new"
    ...
    public void testCreateBandValide() throws Exception{
        // given: un objet MockMvc qui simule des échanges MVC
        // when: on simule une requête HTTP de type POST vers "/band/"
